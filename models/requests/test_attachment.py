...
class TestAttachment:
    ...
    def test_constructor_unknown_attachment_type(self) -> None:
        """
        Verify that an Attachment retains the provided attachment_type, content_type, and content when given an unrecognized content type.
        
        Asserts that `attachment_type` is "configuration", `content_type` is "unknown/type", and `content` matches the supplied multi-line YAML string.
        """

...
class TestRlsapiV1InferResponse:
    ...
    def test_serialization_roundtrip(
        ...
        """
        Verify that RlsapiV1InferResponse serializes to JSON and restores the same nested data when deserialized.
        
        Asserts that the deserialized response's `data.text` and `data.request_id` match the original instance.
        """

...
class TestQueryRequest:
    ...
    def test_get_documents(self) -> None:
        """
        Verify that QueryRequest.get_documents converts attachments into document dictionaries with correct content and mime_type.
    ...
    def test_validate_media_type(self, mocker: MockerFixture) -> None:
        ...
        Patches the module logger, constructs a QueryRequest with provider, model, and media_type "text/plain", and asserts the logger's warning method was not called.
        """

...
class TestRAGChunk:
    ...
    def test_constructor_with_all_fields(self) -> None:
        """
        Verify that providing content, source, and score assigns those values to the RAGChunk instance.
        
        Asserts that the chunk's `content`, `source`, and `score` fields equal the values passed to the constructor.
        """
        chunk = RAGChunk(
    ...
    def test_multiline_content(self) -> None:
        """
        Verify that a RAGChunk preserves multiline content and stores the provided source and score.
        
        Asserts that the chunk's `content` equals the original multiline string, `source` equals "docs/multiline.md", and `score` equals 0.88.
        """

...
def mock_tools_response(mocker: MockerFixture) -> list[MockType]:
    """
    Create two mock tool objects that mimic LlamaStack client tool responses.
    
    Each mock supports mapping-like access (so dict() conversion, iteration, and item access work)
    and contains fields: 'identifier', 'description', 'parameters', 'provider_id',
    'toolgroup_id', 'type', and 'metadata'.

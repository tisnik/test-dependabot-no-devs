...
def test_get_logger_log_level(
    ...
    """
    Verifies that setting the log-level environment variable produces a logger with the corresponding numeric level, matching level names case-insensitively.
    """

...
class QueryRequest(BaseModel):
    ...
    def check_uuid(cls, value: str | None) -> str | None:
        ...
        Raises:
            ValueError: If `value` is provided and does not conform to the expected SUID format.
        """
    ...
    def get_documents(self) -> list[Document]:
        ...
        Returns:
            list[Document]: Documents created from attachments; empty list if there are no attachments.
        """
...
class FeedbackRequest(BaseModel):
    ...
    def validate_categories(
        ...
        Converts an empty list to None for consistency and removes duplicate categories while preserving their original order. If `value` is None, it is returned unchanged.

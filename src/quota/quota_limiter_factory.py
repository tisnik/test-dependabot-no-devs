...
class QuotaLimiterFactory:
    ...
    def quota_limiters(config: QuotaHandlersConfiguration) -> list[QuotaLimiter]:
        """
        Create quota limiter instances from the provided quota handlers configuration.
        
        Parameters:
            config (QuotaHandlersConfiguration): Configuration containing storage settings and limiter definitions.
        
        Returns:
            list[QuotaLimiter]: List of initialized quota limiter instances. Returns an empty list if storage configuration or limiter definitions are missing.
        """
    ...
    def create_limiter(
        ...
        Parameters:
            configuration (QuotaHandlersConfiguration): Configuration used to initialize the limiter.

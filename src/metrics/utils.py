...
def update_llm_token_count_from_turn(
    ...
    `llm_token_received_total` and `llm_token_sent_total` using the provided `provider` and `model`
    as label values.
    ...
    Parameters:
        ...
        system_prompt (str): Optional system prompt text to prepend to the input messages before counting.
    """
